...
class Routes(
  ...
  // @LINE:8
  ConferenceController_2: controllers.ConferenceController,
  // @LINE:10
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:10
    UserController_1: controllers.UserController
  ) = this(errorHandler, HomeController_0, ConferenceController_2, UserController_1, "/")

  import ReverseRouteContext.empty

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_0, ConferenceController_2, UserController_1, prefix)
  }
  ...
  private[this] lazy val controllers_ConferenceController_findConferenceLocations1_invoker = createInvoker(
    ConferenceController_2.findConferenceLocations(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_ConferenceController_findConferenceLocations1_route(params) =>
      call { 
        controllers_ConferenceController_findConferenceLocations1_invoker.call(ConferenceController_2.findConferenceLocations())
      }
